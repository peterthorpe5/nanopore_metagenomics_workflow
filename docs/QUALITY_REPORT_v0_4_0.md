# Quality report: v0.4.0

Release date: 10 August 2026

## Scope

This release replaces bundled classifier jobs with a detached, journalled
Slurm DAG containing independent per-sample arrays. It adds exact PCR truth
validation and concordance reporting, restart-safe per-sample completion
records, and minimap2 protections against multipart-index count inflation.
...
- 126 unit and integration tests pass under Python 3.12.
...
- the masked FASTA must expose both PCR-expected species before index building;
